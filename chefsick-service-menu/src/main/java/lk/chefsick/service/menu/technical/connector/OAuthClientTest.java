package lk.chefsick.service.menu.technical.connector;
...
public class OAuthClientTest {
    ...
    public ResponseEntity<Map> testClient() {
        try {
            ...
            ResponseEntity<Map> responseEntity = restTemplate.exchange("http://localhost:8080/oauth/token", HttpMethod.POST, entity, Map.class);
